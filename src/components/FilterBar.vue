...
const filters = [
  ...
  { label: 'Mais salvos',  value: 'saved'   },
  { label: 'Com clipe',    value: 'hasClip' },
]
</script>

<template>
  <div class="overflow-x-auto scrollbar-hide flex gap-2 py-2">
    <button
      v-for="f in filters"
      :key="f.value"
      class="flex-shrink-0 px-4 py-1.5 rounded-full text-sm whitespace-nowrap cursor-pointer
